...
<main>
 <div class="tg-hero-area tg-hero-tu-wrapper include-bg" data-background="assets/img/hero/tu/banner.jpg">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-10">
                        <div class="tg-hero-content text-center">
                            <div class="tg-hero-title-box mb-30">
                                <h2 class="tg-hero-title wow fadeInUp" data-wow-delay=".4s" data-wow-duration=".5s">A journey of a thousand miles begins with a single step</h2>
                            ...
                            <!-- <div class="tg-hero-tu-avatar-wrap d-flex justify-content-center flex-wrap align-items-center wow fadeInUp" data-wow-delay=".4s" data-wow-duration=".9s">
                                <span class="tg-hero-tu-avatar d-inline-block mr-10 mb-15">
                                    <img src="assets/img/hero/tu/avatar.png" alt="">
                                </span>
                            ...
                            <div style="margin-top:90px !important;" class="tg-booking-form-item tg-booking-tu-wrapper mt-15">
                                <form action="#">
...
<section class="container py-5">
  <h2 class="text-center fw-bold mb-5" style="color:#0B2251;">
    Why Choose <span style="color:#F07C00;">Air Routes Finder</span>
  </h2>
      ...
      <div class="row g-4">
        <div class="col-md-6">
          <div class="p-4 shadow-sm rounded bg-white text-center h-100">
            <div class="mb-3">
           <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="currentColor" class="bi bi-check-all" viewBox="0 0 16 16">
  <path d="M8.97 4.97a.75.75 0 0 1 1.07 1.05l-3.99 4.99a.75.75 0 0 1-1.08.02L2.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093L8.95 4.992zm-.92 5.14.92.92a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 1 0-1.091-1.028L9.477 9.417l-.485-.486z"/>
</svg>
            </div>
            <h5 class="fw-bold">Compare & Book</h5>
            <p class="text-muted mb-0">
              Instantly compare airfares from multiple airlines and get the best available deals — all in one place.
            </p>
          </div>
        </div>
        ...
        <div class="col-md-6">
          <div class="p-4 shadow-sm rounded bg-white text-center h-100">
            <div class="mb-3">
              <img src="https://cdn-icons-png.flaticon.com/512/1077/1077035.png" width="40" alt="Fast Booking Icon">
            </div>
            <h5 class="fw-bold">Easy Navigation</h5>
            <p class="text-muted mb-0">
              Our user-friendly interface helps you search and book flights with ease — no confusion, just convenience.
            </p>
          </div>
        </div>
        ...
        <div class="col-md-6">
          <div class="p-4 shadow-sm rounded bg-white text-center h-100">
            <div class="mb-3">
              <img src="https://cdn-icons-png.flaticon.com/512/1827/1827370.png" width="40" alt="Support Icon">
            </div>
            <h5 class="fw-bold">Customer Support</h5>
            <p class="text-muted mb-0">
              Our dedicated support team is available round the clock to assist you with bookings and travel queries.
            </p>
          </div>
        </div>
        ...
        <div class="col-md-6">
          <div class="p-4 shadow-sm rounded bg-white text-center h-100">
            <div class="mb-3">
              <img src="https://cdn-icons-png.flaticon.com/512/190/190411.png" width="40" alt="Deal Icon">
            </div>
            <h5 class="fw-bold">Best Route Suggestions</h5>
            <p class="text-muted mb-0">
              Discover optimal routes tailored to your needs — save time, money, and effort with every journey.
            </p>
          </div>
        </div>
      </div>
    ...
    <div class="col-md-4 mt-4 mt-md-0">
      <div class="rounded shadow-sm overflow-hidden border border-warning border-3">
        <img style="height: 335px;" src="assets/img/spainchoose.jpg" alt="Air Routes Finder" class="img-fluid w-100">
      </div>
    </div>
  </div>
</section>
...
<section class="container py-5">
  <h1 class="fw-bold">Cheap Flight Tickets on Budget – With Air Routes Finder!</h1>
  <p>
    Air Routes Finder is a trusted flight booking platform dedicated to offering travelers affordable flight options to destinations around the globe. As airfare continues to rise daily, we understand the need for budget-friendly alternatives without compromising comfort or convenience. Whether it's top airlines like Delta, Emirates, Lufthansa, or low-cost carriers, we bring you exclusive deals that help you fly smarter.
  </p>

  <p>
    Our platform includes special promotions for Business and First Class tickets, with options for both domestic and international travel. Whether you're flying for a family vacation, business meeting, or an emergency, Air Routes Finder ensures access to competitively priced tickets. Even a small discount makes a big difference, and that’s where we excel — offering you those valuable savings.
  </p>

  <p>
    With Air Routes Finder, you can easily search and book cheap flights that match your schedule and budget. We aggregate prices across a wide range of carriers to give you the best possible deal. No matter where you’re flying from or to, we make sure your experience is smooth, affordable, and stress-free.
  </p>

  <h2 class="fw-bold mt-5">Get Cheap Flight Deals with Air Routes Finder</h2>
  <p>
    Just enter your departure and arrival cities, date of journey, and number of passengers, and within seconds, Air Routes Finder’s powerful search engine will fetch the most budget-friendly and suitable options available. Our user-friendly system sorts flights by price, helping you select the right one with ease.
  </p>

  <h3 class="fw-bold mt-4">Why Air Routes Finder?</h3>
  <p>
    Let go of your worries over overpriced airfare. Switch to Air Routes Finder and enjoy cheaper tickets without compromising on comfort. Save your money for experiences at your destination rather than splurging on flight fares. We’re here to make your travel plans cost-effective, convenient, and truly enjoyable. Happy flying!
  </p>
</section>
        ...
        <div style="padding-top:0px;" class="tg-location-area p-relative z-index-1 pb-65 pt-120">
                        ...
                        <div class="swiper-container tg-location-su-slider">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="tg-location-3-wrap  tg-location-su-wrap  p-relative mb-30 tg-round-25">
                                        <div class="tg-location-thumb tg-round-25">
                                            <img class="w-100 tg-round-25" style="height:250px;width:100%;" src="assets/img/destination/tu/des-4.jpg" alt="location">
                                        </div>
                                        <div class="tg-location-content tg-location-su-content">
                                            <div class="content">
                                                <h3 class="tg-location-title mb-5"><a href="flighttomexico.php">Mexico</a></h3>
                                ...
                                <div class="swiper-slide">
                                    <div class="tg-location-3-wrap  tg-location-su-wrap  p-relative mb-30 tg-round-25">
                                        <div class="tg-location-thumb tg-round-25">
                                            <img class="w-100 tg-round-25" style="height:250px;width:100%;" src="assets/img/destination/tu/des-2.jpg" alt="location">
                                        </div>
                                        <div class="tg-location-content tg-location-su-content">
                                            <div class="content">
                                                <h3 class="tg-location-title mb-5"><a href="flighttospain.php">Spain</a></h3>
                                                <!-- <span class="tg-location-su-duration">05 Tours</span> -->
                                            </div>
                                            <a class="icons" href="tour-grid-1.html">
                                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="swiper-slide">
                                    <div class="tg-location-3-wrap  tg-location-su-wrap  p-relative mb-30 tg-round-25">
                                        <div class="tg-location-thumb tg-round-25">
                                            <img class="w-100 tg-round-25" style="height:250px;width:100%;" src="assets/img/destination/tu/des-3.jpg" alt="location">
                                        </div>
                                        <div class="tg-location-content tg-location-su-content">
                                            <div class="content">
                                                <h3 class="tg-location-title mb-5"><a href="flighttousa.php">USA</a></h3>
                                                <!-- <span class="tg-location-su-duration">05 Tours</span> -->
                                            </div>
                                            <a class="icons" href="tour-grid-1.html">
                                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="swiper-slide">
                                    <div class="tg-location-3-wrap  tg-location-su-wrap  p-relative mb-30 tg-round-25">
                                        <div class="tg-location-thumb tg-round-25">
                                            <img class="w-100 tg-round-25" style="height:250px;width:100%;" src="assets/img/destination/tu/france.jpg" alt="location">
                                        </div>
                                        <div class="tg-location-content tg-location-su-content">
                                            <div class="content">
                                                <h3 class="tg-location-title mb-5"><a href="flighttofrance.php">France</a></h3>
                                ...
                                <div class="swiper-slide">
                                    <div class="tg-location-3-wrap  tg-location-su-wrap  p-relative mb-30 tg-round-25">
                                        <div class="tg-location-thumb tg-round-25">
                                            <img class="w-100 tg-round-25" style="height:250px;width:100%;" src="assets/img/destination/tu/brazil.jpg" alt="location">
                                        </div>
                                        <div class="tg-location-content tg-location-su-content">
                                            <div class="content">
                                                <h3 class="tg-location-title mb-5"><a href="flighttobrazil.php">Brazil</a></h3>
                                                <!-- <span class="tg-location-su-duration">05 Tours</span> -->
                                            </div>
                                            <a class="icons" href="tour-grid-1.html">
                                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="swiper-slide">
                                    <div class="tg-location-3-wrap  tg-location-su-wrap  p-relative mb-30 tg-round-25">
                                        <div class="tg-location-thumb tg-round-25">
                                            <img class="w-100 tg-round-25" style="height:250px;width:100%;" src="assets/img/destination/tu/uk.jpg" alt="location">
                                        </div>
                                        <div class="tg-location-content tg-location-su-content">
                                            <div class="content">
                                                <h3 class="tg-location-title mb-5"><a href="flighttouk.php">United Kingdom</a></h3>
                                                <!-- <span class="tg-location-su-duration">05 Tours</span> -->
                                            </div>
                                            <a class="icons" href="tour-grid-1.html">
                                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="swiper-slide">
                                    <div class="tg-location-3-wrap  tg-location-su-wrap  p-relative mb-30 tg-round-25">
                                        <div class="tg-location-thumb tg-round-25">
                                            <img class="w-100 tg-round-25" style="height:250px;width:100%;" src="assets/img/destination/tu/colombia.jpg" alt="location">
                                        </div>
                                        <div class="tg-location-content tg-location-su-content">
                                            <div class="content">
                                                <h3 class="tg-location-title mb-5"><a href="flighttocolumbia.php">Colombia</a></h3>
                                                <!-- <span class="tg-location-su-duration">05 Tours</span> -->
                                            </div>
                                            <a class="icons" href="tour-grid-1.html">
                                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="col-lg-7">
                        <div class="tg-about-su-content-wrap ml-80 mb-30 wow fadeInRight" data-wow-delay=".4s" data-wow-duration=".6s">
                            <div class="tg-location-section-title mb-30">
                                ...
                                <h2 class="tg-section-su-title text-capitalize mb-15">Discover Unmatched Opportunities with</h2>
                                <p class="tg-section-su-para mb-10">Explore the world with confidence. Air Routes Finder connects you with top destinations and seamless travel experiences. Whether you're planning your next vacation or a business trip, we've got you covered.</p>
                            </div>
                            <div class="tg-about-su-funfact-wrap mb-40">
                                <div class="tg-about-su-funfact-item mb-15">
                                    <div class="tg-about-su-funfact-icon mb-20">
                                        <img src="assets/img/about/su/fun-3.png" alt="">
                                    </div>
                                ...
                                <div class="tg-about-su-funfact-item mb-15">
                                    <div class="tg-about-su-funfact-icon mb-20">
                                        <img src="assets/img/about/su/fun-2.png" alt="">
                                    </div>
                                    <div class="tg-about-su-funfact-text">
                                ...
                                <div class="tg-about-su-funfact-item mb-15">
                                    <div class="tg-about-su-funfact-icon mb-20">
                                        <img src="assets/img/about/su/fun-1.png" alt="">
                                    </div>
                                    <div class="tg-about-su-funfact-text">
                                        <h3 class="mb-0">7,000+</h3>
                            ...
                            <div class="tg-about-su-author-wrap">
                                <div class="mr-30 mb-10">
                                    <a class="tg-btn tg-btn-hover" href="about.html">Read More</a>
                                </div>
