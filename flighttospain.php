                    ...
                    <div class="col-xl-10">
                        <div class="tg-hero-content text-center">
                            <div class="tg-hero-title-box mb-30">
                                <h2 class="tg-hero-title wow fadeInUp" data-wow-delay=".4s" data-wow-duration=".5s">Flights to Spain</h2>
...
<section class="container py-5">
  <h2 style="color:#560CE3;" class=" fw-bold">About Spain</h2>
  <p style="line-height:38px !important;" class="fs-4 text-left">
    Spain is a country rich in culture, history, and natural beauty. From world-famous architecture in Barcelona to flamenco dancing in Seville, Spain offers a vibrant mix of old-world charm and modern attractions. Known for its delicious cuisine, sunny beaches, and festive atmosphere, Spain attracts millions of visitors each year. Whether you're exploring ancient Roman ruins or relaxing along the Mediterranean coast, Spain delivers unforgettable experiences for every kind of traveler.
  </p>

  <div class="border-start border-4 border-info ps-3 my-4">
    <h3 style="color:#0B475E;" class="fw-bold text-left">The Best Place to Visit in Spain:</h3>
    <h4 style="color:#0B475E;" class="fw-bold  fs-4 text-left">Park Güell, Barcelona:</h4>
    <p class="text-left">
      Park Güell is a colorful public park designed by Antoni Gaudí, located in the heart of Barcelona. Featuring whimsical architecture, mosaic-covered structures, and panoramic views of the city, it’s a must-visit destination for art and nature lovers alike.
    </p>
  </div>

  <div class="border-start border-4 border-danger ps-3 my-4">
    <h5 style="color:#0B475E;" class="fw-bold  fs-4 text-left">The Alhambra, Granada</h5>
    <p class="text-left">
      The Alhambra is a majestic palace and fortress complex that showcases stunning Moorish architecture. Set against the backdrop of the Sierra Nevada mountains, it captivates visitors with its intricate carvings, lush gardens, and historical significance.
    </p>
  </div>

  <div class="border-start border-4 border-warning ps-3 my-4">
    <h5 style="color:#0B475E;" class="fw-bold text-left fs-4">La Tomatina Festival, Buñol</h5>
    <p class="text-left">
      La Tomatina is a unique and energetic festival held every August where participants throw thousands of tomatoes at each other. This messy yet exhilarating event draws people from around the world for a once-in-a-lifetime experience in Spanish tradition and fun.
    </p>
  </div>
  ...
  <div class="card shadow-sm p-4">
    <div class="row align-items-center">
      ...
      <div class="col-md-6 d-flex align-items-center mb-3 mb-md-0">
        <img src="https://cdn-icons-png.flaticon.com/512/561/561127.png" alt="Mail Icon" width="50" class="me-3">
        <div>
          <h5 class="fw-bold mb-1">Stay Inspired</h5>
          <p class="mb-0 text-muted">Curated travel content to inspire future adventures. Sign up today and let travel dreams run wild.</p>
        </div>
      </div>
      ...
      <div class="col-md-6">
        <div class="input-group">
          <input type="email" class="form-control bg-dark text-white rounded-start" placeholder="Enter your email" aria-label="Email">
