                    ...
                    <div class="col-xl-10">
                        <div class="tg-hero-content text-center">
                            <div class="tg-hero-title-box mb-30">
                                <h2 class="tg-hero-title wow fadeInUp" data-wow-delay=".4s" data-wow-duration=".5s">Flights to USA</h2>
...
<section class="container py-5">
  <h2 style="color:#560CE3;" class="fw-bold">About United States</h2>
  <p style="line-height:38px !important;" class="fs-4 text-left">
    The United States is a vast and diverse country offering everything from natural wonders to iconic cities. Whether you're gazing at the Grand Canyon, enjoying Broadway in New York, or road-tripping on Route 66, the USA promises adventure and cultural richness at every turn. Its regions offer unique character—from the jazz-filled streets of New Orleans to the tech hubs of Silicon Valley. Discover world-class national parks, multicultural cuisine, architectural marvels, and vibrant festivals that reflect the nation’s dynamic spirit and global influence.
  </p>

  <div class="border-start border-4 border-info ps-3 my-4">
    <h3 style="color:#0B475E;" class="fw-bold text-left">The Best Place to Visit in the USA:</h3>
    <h4 style="color:#0B475E;" class="fw-bold fs-4 text-left">Statue of Liberty, New York:</h4>
    <p class="text-left">
      A universal symbol of freedom and democracy, the Statue of Liberty stands proudly in New York Harbor. Visitors can explore Liberty Island and enjoy views of the Manhattan skyline.
    </p>
  </div>

  <div class="border-start border-4 border-danger ps-3 my-4">
    <h5 style="color:#0B475E;" class="fw-bold fs-4 text-left">Grand Canyon, Arizona</h5>
    <p class="text-left">
      One of the Seven Natural Wonders of the World, the Grand Canyon offers breathtaking views, hiking trails, and rafting experiences. Its sheer size and beauty make it a must-see destination for nature lovers.
    </p>
  </div>

  <div class="border-start border-4 border-warning ps-3 my-4">
    <h5 style="color:#0B475E;" class="fw-bold text-left fs-4">Walt Disney World, Florida</h5>
    <p class="text-left">
      A magical place for families and dreamers, Walt Disney World is more than a theme park — it’s an immersive entertainment world filled with rides, parades, characters, and unforgettable memories.
    </p>
  </div>
