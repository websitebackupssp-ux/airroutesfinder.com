                    ...
                    <div class="col-xl-10">
                        <div class="tg-hero-content text-center">
                            <div class="tg-hero-title-box mb-30">
                                <h2 class="tg-hero-title wow fadeInUp" data-wow-delay=".4s" data-wow-duration=".5s">Flights to Columbia</h2>
...
<section class="container py-5">
  <h2 style="color:#560CE3;" class="fw-bold">About Colombia</h2>
  <p style="line-height:38px !important;" class="fs-4 text-left">
    Colombia is a country of contrasts — from misty mountain villages to vibrant Caribbean coasts. Known for its rich coffee culture, colonial architecture, and welcoming people, Colombia has emerged as one of South America's most exciting travel destinations. Explore the colorful streets of Cartagena, trek through the Cocora Valley, or dive into the rhythms of Medellín. With diverse ecosystems, from Amazon jungles to Andean peaks, Colombia invites you to experience its magic, resilience, and endless cultural variety.
  </p>

  <div class="border-start border-4 border-info ps-3 my-4">
    <h3 style="color:#0B475E;" class="fw-bold text-left">The Best Place to Visit in Colombia:</h3>
    <h4 style="color:#0B475E;" class="fw-bold fs-4 text-left">Cartagena's Walled City:</h4>
    <p class="text-left">
      Cartagena’s Old Town is a UNESCO World Heritage site filled with vibrant facades, cobbled streets, and historic fortresses. It’s a perfect blend of colonial charm and Caribbean soul.
    </p>
  </div>

  <div class="border-start border-4 border-danger ps-3 my-4">
    <h5 style="color:#0B475E;" class="fw-bold fs-4 text-left">Cocora Valley</h5>
    <p class="text-left">
      Home to Colombia’s national tree, the towering wax palm, Cocora Valley is a surreal landscape nestled in the Andes. Ideal for trekking, it offers misty forests and dreamlike views.
    </p>
  </div>

  <div class="border-start border-4 border-warning ps-3 my-4">
    <h5 style="color:#0B475E;" class="fw-bold text-left fs-4">Medellín, the City of Eternal Spring</h5>
    <p class="text-left">
      Once infamous, Medellín is now celebrated for innovation, cable cars, and urban renewal. With perfect weather year-round and an energetic culture, it’s a shining example of Colombia’s transformation.
    </p>
  </div>
