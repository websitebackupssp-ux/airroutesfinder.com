                    ...
                    <div class="col-xl-10">
                        <div class="tg-hero-content text-center">
                            <div class="tg-hero-title-box mb-30">
                                <h2 class="tg-hero-title wow fadeInUp" data-wow-delay=".4s" data-wow-duration=".5s">Flights to Brazil</h2>
...
<section class="container py-5">
  <h2 style="color:#560CE3;" class="fw-bold">About Brazil</h2>
  <p style="line-height:38px !important;" class="fs-4 text-left">
    Brazil is a land of vibrant rhythms, lush rainforests, and colorful culture. Home to the Amazon River, Christ the Redeemer, and world-famous Carnival, Brazil captivates the senses like no other. From the beaches of Rio de Janeiro to the waterfalls of Iguaçu, the country offers extraordinary natural beauty and energy. Visitors can explore colonial towns, hike through jungle trails, or dance to samba beats under starry skies. Brazil is a mosaic of traditions, biodiversity, and festive spirit, offering an unforgettable adventure.
  </p>

  <div class="border-start border-4 border-info ps-3 my-4">
    <h3 style="color:#0B475E;" class="fw-bold text-left">The Best Place to Visit in Brazil:</h3>
    <h4 style="color:#0B475E;" class="fw-bold fs-4 text-left">Christ the Redeemer, Rio de Janeiro:</h4>
    <p class="text-left">
      Towering over Rio, Christ the Redeemer is one of the most iconic monuments in the world. Offering panoramic views of the city and ocean, it’s a symbol of peace and a must-see landmark.
    </p>
  </div>

  <div class="border-start border-4 border-danger ps-3 my-4">
    <h5 style="color:#0B475E;" class="fw-bold fs-4 text-left">Amazon Rainforest</h5>
    <p class="text-left">
      The Amazon Rainforest is a haven of biodiversity and wonder. Visitors can cruise the river, witness rare wildlife, and experience the world’s largest tropical forest firsthand — a true ecological treasure.
    </p>
  </div>

  <div class="border-start border-4 border-warning ps-3 my-4">
    <h5 style="color:#0B475E;" class="fw-bold text-left fs-4">Iguaçu Falls</h5>
    <p class="text-left">
      Located at the border with Argentina, Iguaçu Falls is a breathtaking network of over 270 cascades. It’s one of the most spectacular waterfalls on Earth and a UNESCO World Heritage site.
    </p>
  </div>
