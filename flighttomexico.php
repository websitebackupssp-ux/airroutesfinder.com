                    ...
                    <div class="col-xl-10">
                        <div class="tg-hero-content text-center">
                            <div class="tg-hero-title-box mb-30">
                                <h2 class="tg-hero-title wow fadeInUp" data-wow-delay=".4s" data-wow-duration=".5s">Flights to Mexico</h2>
...
<section class="container py-5">
  <h2 style="color:#560CE3;" class="fw-bold">About Mexico</h2>
  <p style="line-height:38px !important;" class="fs-4 text-left">
    Mexico is a country bursting with color, tradition, and life. Known for its ancient Mayan and Aztec ruins, vibrant festivals, and delicious cuisine, Mexico offers a diverse travel experience. Whether relaxing on the beaches of Cancun or exploring cultural landmarks in Mexico City, travelers are welcomed with warmth and hospitality.
  </p>

  <div class="border-start border-4 border-info ps-3 my-4">
    <h3 style="color:#0B475E;" class="fw-bold text-left">The Best Place to Visit in Mexico:</h3>
    <h4 style="color:#0B475E;" class="fw-bold fs-4 text-left">Chichén Itzá, Yucatán:</h4>
    <p class="text-left">
      One of the New Seven Wonders of the World, Chichén Itzá is an ancient Mayan city with the famous pyramid of El Castillo. Its rich history and architectural brilliance make it a must-visit archaeological site.
    </p>
  </div>

  <div class="border-start border-4 border-danger ps-3 my-4">
    <h5 style="color:#0B475E;" class="fw-bold fs-4 text-left">Cancún Beaches</h5>
    <p class="text-left">
      The pristine white-sand beaches and turquoise waters of Cancún attract visitors from around the world. It’s a perfect mix of natural beauty, luxury resorts, and exciting nightlife.
    </p>
  </div>

  <div class="border-start border-4 border-warning ps-3 my-4">
    <h5 style="color:#0B475E;" class="fw-bold text-left fs-4">Day of the Dead Festival</h5>
    <p class="text-left">
      Día de los Muertos is a vibrant celebration of life and death. Held every November, it features colorful altars, marigold flowers, and traditional food honoring ancestors with joy and remembrance.
    </p>
  </div>
