                    ...
                    <div class="col-xl-10">
                        <div class="tg-hero-content text-center">
                            <div class="tg-hero-title-box mb-30">
                                <h2 class="tg-hero-title wow fadeInUp" data-wow-delay=".4s" data-wow-duration=".5s">Flights to France</h2>
...
<section class="container py-5">
  <h2 style="color:#560CE3;" class="fw-bold">About France</h2>
  <p style="line-height:38px !important;" class="fs-4 text-left">
     France is a country synonymous with romance, art, and gastronomy. From the historic streets of Paris to the lavender fields of Provence, France offers unforgettable experiences. Whether exploring world-class museums or enjoying fine wine in Bordeaux, France captivates every traveler. With its scenic countryside, iconic landmarks, charming coastal towns, and rich regional traditions, visitors can indulge in a perfect blend of old-world elegance and contemporary culture. Each region tells a unique story through its architecture, cuisine, and local charm.
  </p>

  <div class="border-start border-4 border-info ps-3 my-4">
    <h3 style="color:#0B475E;" class="fw-bold text-left">The Best Place to Visit in France:</h3>
    <h4 style="color:#0B475E;" class="fw-bold fs-4 text-left">Eiffel Tower, Paris:</h4>
    <p class="text-left">
      Standing tall in the heart of Paris, the Eiffel Tower is France’s most iconic symbol. Visitors can enjoy breathtaking panoramic views of the city from its observation decks, especially enchanting at night when it sparkles.
    </p>
  </div>

  <div class="border-start border-4 border-danger ps-3 my-4">
    <h5 style="color:#0B475E;" class="fw-bold fs-4 text-left">The Louvre Museum</h5>
    <p class="text-left">
      Home to the Mona Lisa and thousands of masterpieces, the Louvre is the world’s largest art museum. It's a must-see for art enthusiasts and history lovers alike, offering a journey through time and creativity.
    </p>
  </div>

  <div class="border-start border-4 border-warning ps-3 my-4">
    <h5 style="color:#0B475E;" class="fw-bold text-left fs-4">Provence Lavender Fields</h5>
    <p class="text-left">
      In summer, the rolling hills of Provence are covered in vibrant purple lavender. The breathtaking views and calming scent make this region perfect for relaxation, photography, and scenic road trips.
    </p>
  </div>
